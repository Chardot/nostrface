...
import 'package:nostrface/features/profile_discovery/presentation/screens/discovery_screen_indexed.dart';
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/discovery',
            name: 'discovery',
            builder: (context, state) => const DiscoveryScreenIndexed(),
            routes: [
